...
class Kneuron4(Kneuron):
    ...
    def __init__(self):
        ...
        self._b = [EncodableFloat16(0.0), EncodableFloat16(0.0), EncodableFloat16(0.0), EncodableFloat16(0.0)]
        self.mapping = kc4_mapping
        self.points = numpy.array([1, 2, 3, 4, 5, 6, 7, 8], dtype=int)
#*************************************************************************************************************
